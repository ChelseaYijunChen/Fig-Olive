   ...
   <div class="container marketing">
	<c:forEach items= "${requestScope.productList}" var="product">
      <div class="col-xs-6 col-sm-4 food-item" tabindex="0" data-product-id="43861" data-ga="send,event,product,click,detailsOpen">
		<div class="inner">
			<div class="imgWrap">
				<img src="<c:out value='${product.productImage}'/>" width="300" height="300">
			</div>
			<div class="title row">
			...
			<!-- <form action="CartServlet" method="post"> -->
				<div class="form-group row">
					...
					<a href="EditProductServlet?productId=${product.getProductId()}" class="btn btn-danger">Edit</a>
					<a href="TakeDownProductServlet?productId=${product.getProductId()}" class="btn btn-danger">Take Down</a> 
