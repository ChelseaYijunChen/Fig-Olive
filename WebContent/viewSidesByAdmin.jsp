		...
		<div class="inner">
			...
			<div class="title row">
				...
				<div class="form-group row">
					...
					<a href="EditProductServlet?productId=${sides.getProductId()}" class="btn btn-danger">Edit</a>
					<a href="TakeDownProductServlet?productId=${sides.getProductId()}" class="btn btn-danger">Take Down</a> 
				</div>
